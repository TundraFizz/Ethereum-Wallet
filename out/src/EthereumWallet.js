...
// Public Methods //
////////////////////
// EthereumWallet.prototype.GenerateWallets = async function(walletCount = 1, options){
...
//   }
// }
// EthereumWallet.prototype.EncryptPrivateKey = async function(key, password = "", options){
//   await SetOptions(this, options);
...
// // const chomper: Chomper = new Chomper();
// // const ethereumWallet: any = new EthereumWallet();
// const ethereumWallet: any = new EthereumWallet();
// export { ethereumWallet };
// export default class Database {
//   private db: string;
//   constructor(sdfhksdfsk: any) {
//     this.db = sdfhksdfsk;
//   }
//   YoloTest(): any {
//     return this.db;
